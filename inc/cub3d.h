...
/*   Updated: 2023/10/12 21:35:03 by moduwole         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_data
{
	...
	int		**textures;
	int		**tex_pixels;
	int		*col_ceiling;//done
	int		*col_floor;//done
	int		col_ceiling_int;
	int		col_floor_int;
	char	player_dir;//done
	int		player_x;//done
	int		player_y;//done
	double	player_pos_x;//done
	double	player_pos_y;//done
	double	player_dir_x;//done
	double	player_dir_y;//done
	double	player_plane_x;//done
	double	player_plane_y;///done
	int		player_move_x;
	int		player_move_y;
	int		player_rotate;
